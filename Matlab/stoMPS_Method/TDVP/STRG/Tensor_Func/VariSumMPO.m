function [ C, Ns2, ana ] = VariSumMPO( Para, MPOA, MPOB, varargin )
...
for i = 1:1:max_step
    ...
    for j = len:-1:3
        [C, Ns2, ana_local] = two_site_update_VariSumMPO(EnVA, EnVB, C, j, '-<-', D_max);
...
function [ C, Ns, ana ] = two_site_update_VariSumMPO( EnVA, EnVB, C, pos, dir, D_max )
switch dir
    case '->-'
        Vl1 = EnVA{pos};
        Vl2 = EnVB{pos};
