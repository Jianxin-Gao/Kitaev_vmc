function [ C, Ns2, ana ] = VariProdMPO( Para, MPOA, MPOB )
...
for i = 1:1:max_step
    ...
    for j = len:-1:3
        [C, Ns2, ana_local] = two_site_update_VariProdMPO(EnV, C, j, '-<-', D_max);
...
function [ C, Ns, ana ] = two_site_update_VariProdMPO(EnV, C, pos, dir, D_max )
switch dir
    case '->-'
        Vl = EnV{pos};
        Vr = EnV{pos+1};
